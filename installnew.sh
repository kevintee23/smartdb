...
echo -e "$Cyan \nThe default location for Smart Door Bell files is /home/pi $Color_Off"
echo -e "$Cyan Enter below the directory name beneath this location where you want to install Smart Door Bell $Color_Off"
echo -e "$Cyan If you want Smart DB installed in /home/pi/smartdb, enter $C   olor_Off smartdb $Cyan below. $Color_Off"
echo -e "$Cyan or... if you prefer a different name, like $Color_Off smarthome $Cyan , enter $Color_Off smarthome $Cyan below. $Color_Off"
hpdir="smartdb"
read -p " Directory name for Smart Door Bell (default= $hpdir): " nhpdir
